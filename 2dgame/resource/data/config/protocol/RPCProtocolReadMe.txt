...
数据结构定义 与函数命名
{
    ...
    "method":{
		...
		"G2C_TALISMAN_UPDATE":"PlayerTalisman", 玩家操作之后的更新。
				...
				--神魂
		"C2G_EquipShenHunSet":"uint32,uint8:uint8",					--穿上物品Uid  和 位置(从11开始)   , Uid 为0时 脱装备
		"C2G_EquipShenHunUp":"uint8,table",						--升级物品的uid ,table里放材料的uid
		"G2C_ShenHun_INFO":"PlayerShenHun",--登录时自动发送法宝等级列表
		"G2C_ShenHun_UPDATE":"PlayerShenHun", 玩家操作之后的更新。
		...
		"C2G_ITEM_LOCK":"uint32;uint8"				--装备锁  物品uid,   0 是解锁 1 是上锁 (不同道具不支持锁)
