class ForgeRefineWindow extends BaseCtrlWnd {
    mElemList;
    recvList;
    select;
    stage;
    ...
    public onShow(): void {
        ...
        this.mElemList["label_wndName"].text = Localize_cns("FORGE_TXT2");
        let str = String.format(Localize_cns("FORGE_BTN"), Localize_cns("FORGE_TXT2"))
