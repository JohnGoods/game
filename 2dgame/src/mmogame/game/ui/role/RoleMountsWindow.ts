class RoleMountsWindow extends BaseCtrlWnd {
	...
	public onShow(): void {
		...
		this.mElemList["HeroRide_checkbox"].visible = true;
		this.mElemList["HeroWing_checkbox"].visible = false;
	...
	onRefreshTop() {
		...
		//更新actorview
		FunUITools.updateActorModel(this.type, this, this.select, 1, 3)
	}
