class TianNvLingQiWindow extends BaseCtrlWnd {
	mElemList;
	select: any;
	list: any;
	unreal: any;
	...
	public initObj(...params: any[]) {
		this.type = cellOptionsIndex.TianNvLingQi
	}
	public onLoad(): void {
	...
	public onShow(): void {
		...
		this.mElemList["label_wndName"].text = Localize_cns("TIANNV_TITLE_TXT4");
		...
		this.mElemList["TianNvLingQi_checkbox"].visible = true
		FunUITools.resetUpgradeBtnState(this.type, this, "btn_auto_upgrade", "btn_upgrade")
		this.onRefresh()
		this.onRefreshTop()
		FunUITools.checkExpDan(this.type, this)

		this.mElemList["image_skill"].source = "tn_text07"
		this.mElemList["image_equip"].source = "tn_text08"
	}
	...
	onShowFunFrame(list) {
		...
		wnd.showWithTypeListAndIndex(typelist, 3)
	}
	...
	onTipsClick() {
		...
		wnd.showWithActivity("lingquRule")
	}
