class TianXian_GoddessWnd extends BaseCtrlWnd {
	mElemList;
    select:any;
	list:any;
	unreal:any;
	...
	public initObj(...params: any[]) {
		this.type = cellOptionsIndex.TianXian
		this.isAuto = false
	}
    public onLoad(): void {
	...
	public onShow(): void {
		...
		this.mElemList["title"].text = Localize_cns("TianXian");
		...
		this.mElemList["image_skill"].source = "tx_text01"
		this.mElemList["image_equip"].source = "tx_text02"
   ...
   onTipsClick(){
        ...
        wnd.showWithActivity("tianxianRule")
    }
