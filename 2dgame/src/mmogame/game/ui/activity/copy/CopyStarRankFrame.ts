// TypeScript file
class CopyStarRankFrame extends ActivityRankBaseFrame {
    rankList: any
	...
	refreshItemWindow(window, config, index) {
        ...
        // [totalStar, force, plr:getId(), plr:getName()]
    ...
    refreshHeroRank() {
        ...
        this.mElemList["my_rank1"].text = Localize_cns("COPY_TXT29")
        this.mElemList["my_rank2"].text = this.myConfig[0]
    ...
    //发送协议获取排行数据
	sendRankRequire() {
        RpcProxy.call("C2G_RoleRank", configRankType.RANK_DRAGON_BOSS,1)
		// let message = GetMessage(opCodes.C2G_ROLE_RANK)
		// message.rankType = configRankType.RANK_DRAGON_BOSS
		// message.index = 1
