// TypeScript file
class CarnivalPosUpgradeWindow extends BaseCtrlWnd {
    ...
    public initObj(...params: any[]) {
        ...
        this.name = params[2] || "xwjinjie"                  //天仙进阶
        this.mLayoutPath = params[3]
        this.activityIndex = PayActivityIndex.EVERY_STAGE_B
        this.cellIndex = -1
    }
    ...
    public onLoad(): void {
        ...
        var elemInfo = [
            { ["name"]: this.name + "go_tl", ["title"]: Localize_cns("OPENSERVER_TXT5"), ["color"]: gui.Color.lime, ["event_name"]: gui.TouchEvent.TOUCH_SHORT, ["fun_index"]: this.onLabelGo },
    ...
    onRefresh() {
        let tempList = GetActivity(ActivityDefine.Carnival).getCarnivalUpgrade(this.activityIndex, GameConfig.StageLevelUpBConfig)
